...
.method private appEnabled()Z
    ...
    :try_end_35
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_f .. :try_end_35} :catch_29
    .catchall {:try_start_f .. :try_end_35} :catchall_27
    ...
    monitor-exit p0
    :try_end_54
    .catchall {:try_start_36 .. :try_end_54} :catchall_27
    ...
    monitor-exit p0
    :try_end_58
    .catchall {:try_start_57 .. :try_end_58} :catchall_27
...
.method private restoreCallbacks()V
    ...
    monitor-enter v0
    :try_end_3
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_3} :catch_cd
    ...
    monitor-exit v0
    :try_end_51
    .catchall {:try_start_3 .. :try_end_51} :catchall_3f
    ...
    monitor-enter v0
    :try_end_54
    .catch Ljava/lang/Exception; {:try_start_51 .. :try_end_54} :catch_cd
    ...
    monitor-exit v0
    :try_end_77
    .catchall {:try_start_54 .. :try_end_77} :catchall_6f
    ...
    monitor-enter v0
    :try_end_7a
    .catch Ljava/lang/Exception; {:try_start_77 .. :try_end_7a} :catch_cd
    ...
    monitor-exit v0
    :try_end_c8
    .catchall {:try_start_7a .. :try_end_c8} :catchall_b5

    :try_start_c8
    throw p0
    :try_end_c9
    .catch Ljava/lang/Exception; {:try_start_c8 .. :try_end_c9} :catch_cd

    :goto_c9
    :try_start_c9
    monitor-exit v0
    :try_end_ca
    .catchall {:try_start_c9 .. :try_end_ca} :catchall_6f
    ...
    monitor-exit v0
    :try_end_cc
    .catchall {:try_start_cb .. :try_end_cc} :catchall_3f
...
.method private tryConnecting(Landroid/os/Bundle;)V
    ...
    :try_end_39
    .catchall {:try_start_a .. :try_end_39} :catchall_15
    ...
    :try_end_5b
    .catch Ljava/lang/SecurityException; {:try_start_39 .. :try_end_5b} :catch_5c
    .catchall {:try_start_39 .. :try_end_5b} :catchall_15
    ...
    monitor-exit p0
    :try_end_6f
    .catchall {:try_start_5d .. :try_end_6f} :catchall_15
...
.method public checkPkgValidity()Z
    ...
    :try_end_46
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_a .. :try_end_46} :catch_3f
    .catchall {:try_start_a .. :try_end_46} :catchall_3d
    ...
    monitor-exit p0
    :try_end_75
    .catchall {:try_start_46 .. :try_end_75} :catchall_3d
...
.method public getBrokeredService()Lcom/att/iqi/IIQIService;
    ...
    .catchall {:try_start_2a .. :try_end_2d} :catchall_7
    ...
    monitor-exit p0
    :try_end_4c
    .catchall {:try_start_2f .. :try_end_4c} :catchall_7
...
.method public shouldConnect()Z
    ...
    monitor-exit p0
    :try_end_1b
    .catchall {:try_start_1 .. :try_end_1b} :catchall_15
...
.method public final tryDisconnecting()V
    ...
    monitor-exit p0
    :try_end_24
    .catchall {:try_start_6 .. :try_end_24} :catchall_11
