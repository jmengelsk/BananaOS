...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    move-result p1
    :try_end_6e
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_6a .. :try_end_6e} :catch_7d
    ...
    throw p1
    :try_end_7d
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_78 .. :try_end_7d} :catch_7d
...
.method public static computeAppArtStats(Landroid/content/pm/PackageStats;Ljava/lang/String;)V
    ...
    move-result-object p1
    :try_end_10
    .catchall {:try_start_8 .. :try_end_10} :catchall_34
...
.method public static getDirBytes(Ljava/io/File;)J
    ...
    move-result-wide v5
    :try_end_29
    .catch Ljava/lang/NullPointerException; {:try_start_9 .. :try_end_29} :catch_2e
...
.method public static getFileBytesInDir(Ljava/io/File;Ljava/lang/String;)J
    ...
    move-result-wide v5
    :try_end_27
    .catch Ljava/lang/NullPointerException; {:try_start_9 .. :try_end_27} :catch_2c
...
.method public final getAppCrates(Ljava/lang/String;I[Ljava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    move-result v0
    :try_end_6
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_0 .. :try_end_6} :catch_1f
    ...
    move-result-object v1
    :try_end_10
    .catch Ljava/lang/Exception; {:try_start_a .. :try_end_10} :catch_1a
    ...
    throw v1
    :try_end_1f
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_10 .. :try_end_1f} :catch_1f
...
.method public final getFreeBytes(Ljava/lang/String;Ljava/lang/String;)J
    ...
    move-result-object v3
    :try_end_10
    .catch Ljava/io/FileNotFoundException; {:try_start_a .. :try_end_10} :catch_4a
    .catchall {:try_start_a .. :try_end_10} :catchall_2e
    ...
    :try_end_46
    .catchall {:try_start_10 .. :try_end_46} :catchall_2e
    ...
    throw p1
    :try_end_51
    .catchall {:try_start_4b .. :try_end_51} :catchall_2e
...
.method public final isQuotaSupported(Ljava/lang/String;Ljava/lang/String;)Z
    ...
    move-result p2
    :try_end_6
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_0 .. :try_end_6} :catch_17
    ...
    throw p0
    :try_end_17
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_12 .. :try_end_17} :catch_17
...
.method public final queryArtManagedStats(Ljava/lang/String;II)Landroid/app/usage/StorageStats;
    ...
    move-result-object p1
    :try_end_1f
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_19 .. :try_end_1f} :catch_39
    ...
    :try_end_84
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_6a .. :try_end_84} :catch_87
...
.method public final queryCratesForPackage(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    move-result-object v0
    :try_end_1c
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_14 .. :try_end_1c} :catch_39
...
.method public final queryCratesForUid(Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    :try_end_56
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_43 .. :try_end_56} :catch_59
...
.method public final queryCratesForUser(Ljava/lang/String;ILjava/lang/String;)Landroid/content/pm/ParceledListSlice;
    ...
    move-result p3
    :try_end_25
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_1f .. :try_end_25} :catch_3e
    ...
    move-result-object v0
    :try_end_2f
    .catch Ljava/lang/Exception; {:try_start_29 .. :try_end_2f} :catch_39
    ...
    throw v0
    :try_end_3e
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_2f .. :try_end_3e} :catch_3e
...
.method public final queryExternalStatsForUser(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/ExternalStorageStats;
    ...
    new-array v1, v6, [J
    :try_end_38
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_1e .. :try_end_38} :catch_bb
    ...
    move-result-object v1
    :try_end_3f
    .catch Ljava/lang/Exception; {:try_start_39 .. :try_end_3f} :catch_b6
    ...
    new-array p0, v6, [J
    :try_end_52
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_3f .. :try_end_52} :catch_bb
    ...
    throw v5
    :try_end_93
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_59 .. :try_end_93} :catch_bb
    ...
    throw v5
    :try_end_bb
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_b7 .. :try_end_bb} :catch_bb
...
.method public final queryStatsForPackage(Ljava/lang/String;Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    move-result-object v3
    :try_end_1a
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_12 .. :try_end_1a} :catch_b9
    ...
    :try_end_8d
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_85 .. :try_end_8d} :catch_a9
...
.method public final queryStatsForUid(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    :try_end_7a
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_50 .. :try_end_7a} :catch_9c
    ...
    :try_end_81
    .catch Ljava/lang/NullPointerException; {:try_start_7a .. :try_end_81} :catch_82
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_7a .. :try_end_81} :catch_9c
    ...
    :try_end_99
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_83 .. :try_end_99} :catch_9c
    ...
    :try_end_e3
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_a4 .. :try_end_e3} :catch_fb
...
.method public final queryStatsForUser(Ljava/lang/String;ILjava/lang/String;)Landroid/app/usage/StorageStats;
    ...
    :try_end_5f
    .catch Lcom/android/server/pm/Installer$InstallerException; {:try_start_24 .. :try_end_5f} :catch_77
