...
.method public final forceRecognitionEvent(I)V
    ...
    monitor-exit v0
    :try_end_31
    .catchall {:try_start_2b .. :try_end_31} :catchall_1f
    ...
    monitor-exit v0
    :try_end_3c
    .catchall {:try_start_34 .. :try_end_3c} :catchall_1f
...
.method public final getParameter(II)I
    ...
    monitor-exit v0
    :try_end_3d
    .catchall {:try_start_2f .. :try_end_3d} :catchall_1f
...
.method public final getProperties()Landroid/media/soundtrigger/Properties;
    ...
    monitor-exit v0
    :try_end_2f
    .catchall {:try_start_1c .. :try_end_2f} :catchall_21
...
.method public final loadPhraseSoundModel(Landroid/media/soundtrigger/PhraseSoundModel;Landroid/hardware/soundtrigger3/ISoundTriggerHwCallback;)I
    ...
    monitor-exit v0
    :try_end_4c
    .catchall {:try_start_3 .. :try_end_4c} :catchall_3d
...
.method public final loadSoundModel(Landroid/media/soundtrigger/SoundModel;Landroid/hardware/soundtrigger3/ISoundTriggerHwCallback;)I
    ...
    monitor-exit v0
    :try_end_4e
    .catchall {:try_start_3 .. :try_end_4e} :catchall_3e
...
.method public final queryParameter(II)Landroid/media/soundtrigger/ModelParameterRange;
    ...
    monitor-exit v0
    :try_end_3b
    .catchall {:try_start_34 .. :try_end_3b} :catchall_1f
...
.method public final setParameter(III)V
    ...
    monitor-enter v1
    :try_end_37
    .catchall {:try_start_3 .. :try_end_37} :catchall_1f
    ...
    monitor-exit v0
    :try_end_50
    .catchall {:try_start_48 .. :try_end_50} :catchall_1f
...
.method public final startRecognition(IIILandroid/media/soundtrigger/RecognitionConfig;)V
    ...
    monitor-exit p2
    :try_end_45
    .catchall {:try_start_39 .. :try_end_45} :catchall_1f
    ...
    monitor-exit p2
    :try_end_5c
    .catchall {:try_start_48 .. :try_end_5c} :catchall_1f
...
.method public final unloadSoundModel(I)V
    ...
    monitor-exit v1
    :try_end_29
    .catchall {:try_start_26 .. :try_end_29} :catchall_63
    ...
    monitor-exit v0
    :try_end_62
    .catchall {:try_start_2b .. :try_end_62} :catchall_1f
    ...
    monitor-exit v0
    :try_end_6d
    .catchall {:try_start_65 .. :try_end_6d} :catchall_1f
