...
.method public constructor <init>(Landroid/content/Context;Landroid/os/Handler;Lcom/android/server/voiceinteraction/VoiceInteractionManagerService$VoiceInteractionManagerServiceStub;ILandroid/content/ComponentName;)V
    ...
    :try_end_53
    .catch Landroid/content/pm/PackageManager$NameNotFoundException; {:try_start_4a .. :try_end_53} :catch_da
...
.method public final deliverNewSessionLocked(Landroid/os/IBinder;Landroid/service/voice/IVoiceInteractionSession;Lcom/android/internal/app/IVoiceInteractor;)Z
    ...
    :try_end_20
    .catch Landroid/os/RemoteException; {:try_start_12 .. :try_end_20} :catch_20
...
.method public final dumpLocked(Ljava/io/PrintWriter;)V
    ...
    monitor-exit v2
    :try_end_15b
    .catchall {:try_start_d3 .. :try_end_15b} :catchall_f8
...
.method public final showSessionLocked(Landroid/os/Bundle;ILjava/lang/String;Lcom/android/internal/app/IVoiceInteractionSessionShowCallback;Landroid/os/IBinder;)Z
    ...
    monitor-exit v1
    :try_end_21
    .catchall {:try_start_b .. :try_end_21} :catchall_16
    ...
    :try_end_7d
    .catch Landroid/os/RemoteException; {:try_start_69 .. :try_end_7d} :catch_7e
    ...
    move-result v5
    :try_end_12a
    .catch Landroid/os/RemoteException; {:try_start_124 .. :try_end_12a} :catch_12b
    ...
    :try_end_1b7
    .catch Landroid/os/RemoteException; {:try_start_1ab .. :try_end_1b7} :catch_1b7
    ...
    monitor-exit v2
    :try_end_1e0
    .catchall {:try_start_1da .. :try_end_1e0} :catchall_1de
    ...
    :try_end_22e
    .catchall {:try_start_21a .. :try_end_22e} :catchall_232

    :try_start_22e
    invoke-interface {v0}, Lcom/android/internal/app/IVoiceInteractionSessionListener;->onVoiceSessionShown()V
    :try_end_231
    .catch Landroid/os/RemoteException; {:try_start_22e .. :try_end_231} :catch_234
    ...
    monitor-exit v1
    :try_end_24b
    .catchall {:try_start_235 .. :try_end_24b} :catchall_232
    ...
    :try_end_251
    .catch Landroid/os/RemoteException; {:try_start_24e .. :try_end_251} :catch_251
    ...
    monitor-exit v1
    :try_end_253
    .catchall {:try_start_252 .. :try_end_253} :catchall_16
...
.method public final startAssistantActivityLocked(Ljava/lang/String;IILandroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;Landroid/os/Bundle;)I
    ...
    iget-object v0, p0, Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;->mActiveSession:Lcom/android/server/voiceinteraction/VoiceInteractionSessionConnection;
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_2} :catch_48
    ...
    invoke-static {v1, p0}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_45
    .catch Landroid/os/RemoteException; {:try_start_7 .. :try_end_45} :catch_48
...
.method public final startVoiceActivityLocked(Ljava/lang/String;IILandroid/os/IBinder;Landroid/content/Intent;Ljava/lang/String;)I
    ...
    iget-object v0, p0, Lcom/android/server/voiceinteraction/VoiceInteractionManagerServiceImpl;->mActiveSession:Lcom/android/server/voiceinteraction/VoiceInteractionSessionConnection;
    :try_end_2
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_2} :catch_54
