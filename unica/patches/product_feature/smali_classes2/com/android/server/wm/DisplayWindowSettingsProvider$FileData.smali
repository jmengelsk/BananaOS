...
.method public constructor <init>(Lcom/android/server/wm/DisplayWindowSettingsProvider$ReadableSettingsStorage;)V
    ...
    :try_end_1a
    .catch Ljava/io/IOException; {:try_start_12 .. :try_end_1a} :catch_12a
    ...
    :try_end_98
    .catch Ljava/lang/IllegalStateException; {:try_start_1f .. :try_end_98} :catch_55
    .catch Ljava/lang/NullPointerException; {:try_start_1f .. :try_end_98} :catch_52
    .catch Ljava/lang/NumberFormatException; {:try_start_1f .. :try_end_98} :catch_4f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_1f .. :try_end_98} :catch_4c
    .catch Ljava/io/IOException; {:try_start_1f .. :try_end_98} :catch_49
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_1f .. :try_end_98} :catch_47
    .catchall {:try_start_1f .. :try_end_98} :catchall_44
    ...
    :try_end_9c
    .catch Ljava/io/IOException; {:try_start_99 .. :try_end_9c} :catch_131
    ...
    throw v3
    :try_end_a7
    .catch Ljava/lang/IllegalStateException; {:try_start_9e .. :try_end_a7} :catch_55
    .catch Ljava/lang/NullPointerException; {:try_start_9e .. :try_end_a7} :catch_52
    .catch Ljava/lang/NumberFormatException; {:try_start_9e .. :try_end_a7} :catch_4f
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_9e .. :try_end_a7} :catch_4c
    .catch Ljava/io/IOException; {:try_start_9e .. :try_end_a7} :catch_49
    .catch Ljava/lang/IndexOutOfBoundsException; {:try_start_9e .. :try_end_a7} :catch_47
    .catchall {:try_start_9e .. :try_end_a7} :catchall_44
    ...
    :try_end_b9
    .catchall {:try_start_a7 .. :try_end_b9} :catchall_44

    :goto_b9
    :try_start_b9
    invoke-virtual {p1}, Ljava/io/InputStream;->close()V
    :try_end_bc
    .catch Ljava/io/IOException; {:try_start_b9 .. :try_end_bc} :catch_11c
    ...
    invoke-static {v1, v0}, Landroid/util/Slog;->w(Ljava/lang/String;Ljava/lang/String;)I
    :try_end_11b
    .catchall {:try_start_bd .. :try_end_11b} :catchall_44
