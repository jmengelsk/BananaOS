...
.method public constructor <init>(Landroid/content/Context;Lcom/android/server/security/AttestationVerificationManagerService$DumpLogger;)V
    ...
    :try_end_67
    .catch Ljava/security/cert/CertificateException; {:try_start_21 .. :try_end_67} :catch_81
...
.method public final checkAttestationForPeerDeviceProfile(Landroid/os/Bundle;Lcom/android/server/security/AndroidKeystoreAttestationVerificationAttributes;Lcom/android/server/security/AttestationVerificationPeerDeviceVerifier$MyDumpData;)I
    ...
    throw v1
    :try_end_8b
    .catch Ljava/lang/IllegalStateException; {:try_start_6d .. :try_end_8b} :catch_80
...
.method public final isValidPatchLevel(II)Z
    ...
    move-result-object p0
    :try_end_1b
    .catchall {:try_start_10 .. :try_end_1b} :catchall_67
...
.method public final validateCertificateChain(Ljava/util/List;)V
    ...
    :try_end_a5
    .catch Ljava/io/IOException; {:try_start_69 .. :try_end_a5} :catch_a6
    .catch Lorg/json/JSONException; {:try_start_69 .. :try_end_a5} :catch_a6
    ...
    invoke-static {p1, v1}, Lcom/android/server/security/CertificateRevocationStatusManager;->checkRevocationStatus(Lorg/json/JSONObject;Ljava/util/List;)V
    :try_end_c3
    .catch Ljava/io/IOException; {:try_start_a6 .. :try_end_c3} :catch_c4
    .catch Lorg/json/JSONException; {:try_start_a6 .. :try_end_c3} :catch_c4
    ...
    :try_end_e1
    .catch Ljava/io/IOException; {:try_start_da .. :try_end_e1} :catch_e2
    .catch Lorg/json/JSONException; {:try_start_da .. :try_end_e1} :catch_e2
