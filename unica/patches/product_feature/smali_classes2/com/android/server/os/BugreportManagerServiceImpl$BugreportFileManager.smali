...
.method public final addBugreportMapping(Landroid/util/Pair;Ljava/lang/String;)V
    ...
    monitor-exit v0
    :try_end_26
    .catchall {:try_start_3 .. :try_end_26} :catchall_16
...
.method public final canSkipConsentScreen(Ljava/lang/String;Z)Z
    ...
    monitor-exit v0
    :try_end_59
    .catchall {:try_start_9 .. :try_end_59} :catchall_15
...
.method public final ensureCallerPreviouslyGeneratedFile(Landroid/content/Context;Landroid/content/pm/PackageManager;Landroid/util/Pair;ILjava/lang/String;)V
    ...
    monitor-exit v0
    :try_end_92
    .catchall {:try_start_3 .. :try_end_92} :catchall_41
...
.method public final readBugreportMappingLocked()V
    ...
    :try_end_d
    .catch Ljava/io/FileNotFoundException; {:try_start_7 .. :try_end_d} :catch_bb
    .catch Ljava/io/IOException; {:try_start_7 .. :try_end_d} :catch_b5
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_7 .. :try_end_d} :catch_b5
    ...
    monitor-enter v4
    :try_end_75
    .catchall {:try_start_d .. :try_end_75} :catchall_40
    ...
    :try_end_a4
    .catchall {:try_start_7e .. :try_end_a4} :catchall_40
    ...
    :try_end_a9
    .catch Ljava/io/FileNotFoundException; {:try_start_a6 .. :try_end_a9} :catch_bb
    .catch Ljava/io/IOException; {:try_start_a6 .. :try_end_a9} :catch_b5
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_a6 .. :try_end_a9} :catch_b5
    ...
    throw v1
    :try_end_b5
    .catch Ljava/io/FileNotFoundException; {:try_start_b1 .. :try_end_b5} :catch_bb
    .catch Ljava/io/IOException; {:try_start_b1 .. :try_end_b5} :catch_b5
    .catch Lorg/xmlpull/v1/XmlPullParserException; {:try_start_b1 .. :try_end_b5} :catch_b5
...
.method public final writeBugreportDataLocked()V
    ...
    move-result-object v1
    :try_end_1b
    .catch Ljava/io/IOException; {:try_start_15 .. :try_end_1b} :catch_bf
    ...
    move-result v5
    :try_end_36
    .catchall {:try_start_1b .. :try_end_36} :catchall_82
    ...
    :try_end_ae
    .catchall {:try_start_3b .. :try_end_ae} :catchall_82
    ...
    :try_end_b3
    .catch Ljava/io/IOException; {:try_start_b0 .. :try_end_b3} :catch_bf
    ...
    throw p0
    :try_end_bf
    .catch Ljava/io/IOException; {:try_start_bb .. :try_end_bf} :catch_bf
