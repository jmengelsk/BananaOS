...
.method public final collectTombstones(Ljava/util/ArrayList;III)V
    ...
    :try_end_25
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_22 .. :try_end_25} :catch_26
...
.method public final handleTombstone(Ljava/io/File;)V
    ...
    move-result v5
    :try_end_8f
    .catch Ljava/lang/NumberFormatException; {:try_start_8b .. :try_end_8f} :catch_23a
    ...
    move-result-object v4
    :try_end_9f
    .catch Ljava/io/FileNotFoundException; {:try_start_9b .. :try_end_9f} :catch_206
    ...
    if-eq v0, v15, :cond_132

    const/16 v15, 0xf

    if-eq v0, v15, :cond_fb

    const/4 v14, 0x7

    if-eq v0, v14, :cond_f1
    ...
    move-result v0
    :try_end_10f
    .catch Ljava/io/IOException; {:try_start_b8 .. :try_end_10f} :catch_e2
    .catch Landroid/util/proto/ProtoParseException; {:try_start_b8 .. :try_end_10f} :catch_e2
    ...
    move-result v11
    :try_end_13d
    .catch Ljava/io/IOException; {:try_start_114 .. :try_end_13d} :catch_129
    .catch Landroid/util/proto/ProtoParseException; {:try_start_114 .. :try_end_13d} :catch_129
    ...
    :try_end_178
    .catch Landroid/system/ErrnoException; {:try_start_162 .. :try_end_178} :catch_17a
    ...
    monitor-exit v2
    :try_end_205
    .catchall {:try_start_1e7 .. :try_end_205} :catchall_203
    ...
    move-result-object v0
    :try_end_239
    .catch Ljava/lang/NumberFormatException; {:try_start_223 .. :try_end_239} :catch_23c
    ...
    :try_end_2a5
    .catch Ljava/io/IOException; {:try_start_29c .. :try_end_2a5} :catch_2ac
    ...
    :try_end_2a8
    .catchall {:try_start_2a5 .. :try_end_2a8} :catchall_2ae
    ...
    :try_end_2db
    .catch Ljava/io/IOException; {:try_start_2a8 .. :try_end_2db} :catch_2ac
